...
```shell
bash <(curl -s -L https://cdn.jsdelivr.net/gh/FxPool/SSLMIX@main/install_zh.sh) https://cdn.jsdelivr.net/gh/FxPool/SSLMIX ssmixlinux
```

### 一键安装脚本(linux arm32 v7 (armv7l)架构)

```shell
bash <(curl -s -L https://cdn.jsdelivr.net/gh/FxPool/SSLMIX@main/install_zh.sh) https://cdn.jsdelivr.net/gh/FxPool/SSLMIX ssmixlinux32armv7l
```
